    ...
    table-striped table-sm table-hover">
        ...
        @forelse( $rows as $row )
            <tr class="d-print-table-row">
                ...
                <td class="d-print-table-cell">{{ $row->date_lease_expiry_of_refurb ? \Carbon\Carbon::create($row->date_lease_expiry_of_refurb)->format('Y-m-d') : "" }}</td>
                <td class="d-print-table-cell">{{ $row->date_delivery ? \Carbon\Carbon::create($row->date_delivery)->format('Y-m-d') : "" }}</td>
