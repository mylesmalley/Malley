    ...
    <div class="card-body">
        ...
        <table>
            ...
            <tr>
                ...
                <td> <button onclick="add_image('single_fixed_passenger_no_extension')" class="btn btn-sm action-button  btn-dark">ADD</button>  </td>
...
{{--                <td> <button onclick="add_image('single_fixed_passenger_18in_extension')"   class="btn btn-sm action-button   btn-danger">24"</button>  </td>--}}
            ...
            <tr>
                ...
                <td> <button onclick="add_image('single_folding_passenger_no_extension')" class="btn btn-sm action-button  btn-dark">ADD</button>  </td>
...
{{--                <td> <button onclick="add_image('single_folding_passenger_18in_extension')"   class="btn btn-sm action-button   btn-danger">24"</button>  </td>--}}
            ...
            <tr>
                ...
                <td> <button onclick="add_image('double_fixed_passenger_no_extension')" class="btn btn-sm action-button  btn-dark">ADD</button>  </td>
...
{{--                <td> <button onclick="add_image('double_fixed_passenger_18in_extension')"   class="btn btn-sm action-button   btn-danger">24"</button>  </td>--}}
            ...
            <tr>
                ...
                <td> <button onclick="add_image('double_folding_passenger_no_extension')" class="btn btn-sm action-button  btn-dark">ADD</button>  </td>
...
{{--                <td> <button onclick="add_image('double_folding_passenger_18in_extension')"   class="btn btn-sm action-button   btn-danger">24"</button>  </td>--}}
            ...
            <tr>
                ...
                <td> <button onclick="add_image('single_fixed_driver_no_extension')" class="btn btn-sm action-button  btn-dark">ADD</button>  </td>
...
{{--                <td> <button onclick="add_image('single_fixed_driver_18in_extension')"   class="btn btn-sm action-button   btn-danger">24"</button>  </td>--}}
            ...
            <tr>
                ...
                <td> <button onclick="add_image('single_folding_driver_no_extension')" class="btn btn-sm action-button  btn-dark">ADD</button>  </td>
...
{{--                <td> <button onclick="add_image('single_folding_driver_18in_extension')"   class="btn btn-sm action-button   btn-danger">24"</button>  </td>--}}
            ...
            <tr>
                ...
                <td> <button onclick="add_image('double_fixed_driver_no_extension')" class="btn btn-sm action-button  btn-dark">ADD</button>  </td>
...
{{--                <td> <button onclick="add_image('double_fixed_driver_18in_extension')"   class="btn btn-sm action-button   btn-danger">24"</button>  </td>--}}
            ...
            <tr>
                ...
                <td> <button onclick="add_image('double_folding_driver_no_extension')" class="btn btn-sm action-button  btn-dark">ADD</button>  </td>
