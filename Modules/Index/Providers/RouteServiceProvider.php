...
class RouteServiceProvider extends ServiceProvider
{
   ...
   //     Route::model('bug', BugReport::class);
...
//        Route::model('document', \App\Programs\Documents\Models\Document::class);
//        Route::model('drawing', \App\Models\Drawing::class);
//        Route::model('folder', \App\Programs\Documents\Models\Folder::class);
//        Route::model('form', \App\Models\Form::class);
//        Route::model('fleetAudit', \App\Programs\FleetAudit\Models\FleetAudit::class);
...
//
    ...
    protected function mapWebRoutes()
    {
        Route::middleware(['web', 'auth'])
            ...
            ->group(module_path('Index', '/Routes/web.php'));
    }
    ...
    protected function mapApiRoutes()
    {
        Route::prefix('api')
            ->middleware('api')
            ->namespace($this->moduleNamespace)
            ->group(module_path('Index', '/Routes/api.php'));
    }
}
