...
class QuantityController extends Controller
{
    ...
    {
        return view('index::index.forms.elements.quantity.create', [
    ...
    public function store( Request $request ): RedirectResponse
    {
        ...
        return redirect( "index/forms/checkbox/{$el->id}")
            ->with(['success'=>['Saved new quantity selection block']]);
    }
    ...
    public function update( Request $request ): RedirectResponse
    {
        ...
        return redirect()
            ->back()
            ->with(['success'=>['Saved changes to quantity selection block details']]);
    }
    ...
    public function edit( FormElement $formElement, Request $request ): View
    {
        ...
        return view('index::index.forms.elements.quantity.edit', [
            'basevan' => $baseVan,
            'form' => $form,
