...
class SelectionController extends Controller
{
    ...
    {
        return view('index::index.forms.elements.selection.create', [
    ...
    public function store( Request $request ): RedirectResponse
    {
        ...
        return redirect( "index/forms/selection/{$el->id}")
    ...
    public function update( Request $request ): RedirectResponse
    {
        ...
        return redirect()
            ->back()
            ->with(['success'=>['Saved changes to selection block details']]);
    }
  ...
  //  dd( $existingrules );
      ...
      //  dd($potentialRules);
        ...
        return view('index::index.forms.elements.selection.edit', [
            'basevan' => $baseVan,
            'form' => $form,
