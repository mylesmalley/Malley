...
<head>
    ...
    <title>Shared Documents and Marketing Materials</title>
...
{{--                --}}
{{--                <li class="nav-item">--}}
{{--                    <a class="nav-link active" href="https://blueprint.malleyindustries.com/bugs/create">New Bug</a>--}}
{{--                </li>--}}
{{--                --}}
{{--                @if (  $malley ?? true )--}}
{{--                    <li class="nav-item">--}}
{{--                        <a class="nav-link active" href="http://index.malleyindustries.com/bugs/all">See Bugs</a>--}}
{{--                    </li>--}}
{{--                @endif--}}
{{--            </ul>--}}
{{--        </div>--}}
