    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ url('index/forms/checkbox/create') }}">
                        {{ csrf_field() }}
                        <input type="hidden" name="form_id" id="form_id" value="{{ $form->id }}">
                        <input type="hidden" name="type" id="type" value="checklist">
                        <div class="row">
                            <div class="col-6">
                            ...
                            <div class="col-3 ">
                                <input type="submit" value="Save CheckBox Block" class="btn btn-primary">
                            </div>
                        </div>
