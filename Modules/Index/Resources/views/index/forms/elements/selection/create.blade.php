...
@section('content')
    ...
    <div class="row">
        <div class="col-12">
            <h1> New Selection List ( Pick A, or B, or C...)
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ url('index/forms/selection/create') }}">
                        {{ csrf_field() }}
                        <input type="hidden" name="form_id" id="form_id" value="{{ $form->id }}">
                        <input type="hidden" name="type" id="type" value="selection">
                        <div class="row">
                            <div class="col-6">
                            ...
                            <div class="col-3 ">
                                <input type="submit" value="Save Selection Block" class="btn btn-primary">
                            </div>
                        </div>
