...
@section('content')
    ...
    <div class="row">
        <div class="col-12">
            <h1> {{ $element->label }} Selection List ( Pick A, or B, or C...)
    ...
    @includeIf('index::index.forms.elements.shared.element_details_form',['target'=>'selection'])
        ...
        <div class="col-12">
            <div class="card border-success">
                <div class="card-header bg-success text-white">
                    <h4>Existing Options (User must pick one)</h4>
                </div>
                        ...
                        @foreach($element->items->sortBy('position') as $item)
                            <tr>
                                ...
                                <td>
                                    <form
                                            method="POSt"
                                            action="{{ url('index/forms/selection/') }}"
                                            class="form-inline">
                                        {{ csrf_field() }}
                                        {{ method_field('PATCH') }}
