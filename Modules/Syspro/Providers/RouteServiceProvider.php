...
namespace Modules\Syspro\Providers;
...
class RouteServiceProvider extends ServiceProvider
{
     ...
     * @var string
     */
    protected $moduleNamespace = 'Modules\Syspro\Http\Controllers';
    ...
    protected function mapWebRoutes()
    {
        Route::middleware(['web','auth'])
            ...
            ->group(module_path('Syspro', '/Routes/web.php'));
    }
    ...
    protected function mapApiRoutes()
    {
        Route::prefix('api')
            ->middleware('api')
            ->namespace($this->moduleNamespace)
            ->group(module_path('Syspro', '/Routes/api.php'));
    }
}
